    ...
    <div className="pt-6">
      ...
      {!success && <div className='w-1/4 mx-auto'>
        <form onSubmit={formik.handleSubmit}>
          ...
          <input 
            type="text" 
            className='sm:w-full p-4 block shadow bg-blue-100 my-2 rounded' 
            placeholder='Nome' 
          ...
          <button type='submit' className='sm:w-full bg-black text-yellow-300 px-12 py-4 font-bold rounded-lg shadow-lg hover:shadow mb-6'>Enviar</button>        
        </form>
      </div>}
